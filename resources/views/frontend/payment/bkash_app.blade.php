...
<head>
    ...
    <link rel="stylesheet" href="{{ assets ('assets/css/vendors.css') }}">
    <link rel="stylesheet" href="{{ assets ('assets/css/aiz-core.css') }}">
    <link rel="stylesheet" href="{{ assets ('assets/css/custom-style.css') }}">
</head>
<body>
    ...
    <!-- SCRIPTS -->
    <script src="{{ assets ('assets/js/vendors.js') }}"></script>
